...
const sttaddr = "0x7622Ba633B86e07EfcF4A300C7dB60677a75558e";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x7622Ba633B86e07EfcF4A300C7dB60677a75558e";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://musicbinance.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0x7622Ba633B86e07EfcF4A300C7dB60677a75558e',
                    'symbol': 'MUSIC',
                    'decimals': '9',
                    'image': 'https://musicbinance.com/images/logo.png',
                },
            },
